...
namespace FS.Abp.CodingManagement
{
    ...
    public class CodingManagementWebHostModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    typeof(CodingManagementResource),
                    typeof(CodingManagementDomainSharedModule).Assembly,
                    typeof(CodingManagementApplicationContractsModule).Assembly,
                    typeof(CodingManagementWebHostModule).Assembly
                );
            });
        }
        ...
        private void ConfigureMenu(IConfiguration configuration)
        {
            ...
            {
                options.MenuContributors.Add(new CodingManagementWebHostMenuContributor(configuration));
            });
        }
        ...
        private void ConfigureAuthentication(ServiceConfigurationContext context, IConfiguration configuration)
        {
            context.Services.AddAuthentication(options =>
                ...
                .AddOpenIdConnect("oidc", options =>
                {
                    ...
                    options.Scope.Add("CodingManagement");
        ...
        private void ConfigureAutoMapper()
        {
            ...
            {
                options.AddMaps<CodingManagementWebHostModule>();
            });
        }
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<CodingManagementDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}..{0}src{0}FS.Abp.CodingManagement.Domain", Path.DirectorySeparatorChar)));
        ...
        public override void OnApplicationInitialization(ApplicationInitializationContext context)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "CodingManagement API");
            });
