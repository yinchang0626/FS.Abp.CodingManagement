...
{
    public class CodingManagementWebHostMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public CodingManagementWebHostMenuContributor(IConfiguration configuration)
        {
        ...
        private void AddLogoutItemToMenu(MenuConfigurationContext context)
        {
            ...
            var l = context.ServiceProvider.GetRequiredService<IStringLocalizer<CodingManagementResource>>();
